...
${OBJECTDIR}/src/Almacen_Rutas.o: src/Almacen_Rutas.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Almacen_Rutas.o src/Almacen_Rutas.cpp

${OBJECTDIR}/src/Pais.o: src/Pais.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Pais.o src/Pais.cpp

${OBJECTDIR}/src/Paises.o: src/Paises.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Paises.o src/Paises.cpp
...
${OBJECTDIR}/src/Ruta.o: src/Ruta.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Ruta.o src/Ruta.cpp

${OBJECTDIR}/src/Rutas_Aereas.o: src/Rutas_Aereas.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Rutas_Aereas.o src/Rutas_Aereas.cpp
