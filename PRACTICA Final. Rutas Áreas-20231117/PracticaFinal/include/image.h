...
public :
    ...
    /**
     * 
     * @param nrow fila inical para recortar.
     * @param ncol columna inical para recortar.
     * @param height número de filas para recortar.
     * @param width número de columnas para recortar.
     * @return Image con el recorte.
     * @post el bojeto que llama a la función no se modifica.
     */
    ...
    /**
     * 
     * @return Image con el zoom aplicado.
     */
    
    Image Zoom2X() const;
    
    //metodo auxiliar para hacer la media de dos pixeles
    /**
     * 
     * @param pixel1 primer pixel 
     * @param pixel2 segundo pixel
     * @return media realizada de los dos pixeles dados
     */
    
    byte media_pixel( const byte pixel1, const byte pixel2) const;
    
    //metodo auxiliar para redondear dos pixeles
    /**
     * 
     * @param valor que redondear
     * @return valor redondeado
     */
    byte redondeo(double valor) const;
    

    // Genera un icono como reducción de una imagen.
    /**
     * 
     * @param factor de reduccion de la imagen
    ...
    // Metodo auxiliar para refactorizar segun el factor de reduccion
     /**
     * 
     * @param i coordenada de la fila 
     * @param j coordenada de la columna 
     * @param factor factor de reduccion
     * @return media realizada segun el factor de reduccion
     * 
     */
    
    byte media_pro(int i, int j, int factor) const;
